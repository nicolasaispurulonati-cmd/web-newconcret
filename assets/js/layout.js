  ...
  <div class="mega-inner">
    ...
    <div class="mega-cols">
      ...
      <div class="mega-col">
        ...
        <ul class="mega-links">
          <li><a href="${root}mantenimiento/productos-quimicos/sistema-newconcret/">Sistema NewConcret</a></li>
...
`;
    ...
    function injectLayout() {
        ...
        const SEARCH_DATA = [
            ...
            { name: 'Sistema NewConcret (mantenimiento)', crumb: 'Mantenimiento › Productos químicos', tags: ['sistema','newconcret','tratamiento','sodium','lock','finish','quimico','mantenimiento'], href: root + 'mantenimiento/productos-quimicos/sistema-newconcret/', group: 'Mantenimiento' },
